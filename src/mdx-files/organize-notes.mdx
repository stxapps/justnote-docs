...
1. On any note, please choose a three-dot button -> 'Pin to the top'.
2. To pin multiple notes to the top simultaneously, click the 'Select notes' button in the top bar first. Select as many notes as you want. Then, choose 'More actions' -> 'Pin to the top' in the top bar or right panel.
...
1. On any note, please choose a three-dot button -> 'Add tags' or 'Manage tags'.
2. To add or manage tags on multiple notes simultaneously, click the 'Select notes' button in the top bar first. Select as many notes as you want. Then, choose 'More actions' -> 'Manage tags' in the top bar or right panel.
